...
export const [repositoryUri, setRepositoryUri] =
...
export const [images, setImages] =
  createSignal<ImageItem[] | null | undefined>();
...
export const [lastImageUri, setLastImageUri] =
  createSignal<string | undefined>();
export const [lastReleasedAt, setLastReleasedAt] =
